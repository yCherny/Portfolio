          ...
          <Grid item xs={12} md={5}>
            <Stack spacing={2} alignItems="flex-start" px={5}>
              ...
              <Typography variant="sectionContent" fontWeight={'light'}>
                ...
                accessibility in mind, ensuring my applications are accessible
                to all, regardless of background, language or disability.
              </Typography>
            </Stack>
          </Grid>
          <Grid item xs={12} md={5}>
            <Stack direction={'row'} height={'100wh'} px={5}>
              <Stack spacing={2} style={{ textAlign: 'end' }}>
                ...
                <Typography variant="content" style={{ fontWeight: '400' }}>
                  ...
                  technology, it increasingly becomes more a part of us as we
                  move from desktops, to mobile devices, to AR lenses and
                  virtual assistants. Therefore, I believe it is crucial to
                  design 'mobile-first.'
                </Typography>
              </Stack>
            </Stack>
